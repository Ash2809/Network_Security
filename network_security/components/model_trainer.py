...
from network_security.entity.artifact_entity import Data_transformation_artifact,Model_trainer_artifact
from network_security.entity.config_entity import Model_trainer_config
...
class ModelTrainer():
    ...
    def initiate_model_trainer(self)->Model_trainer_artifact:
        try:
            ...
            model_trainer_artifact = Model_trainer_artifact(trained_model_file_path=self.model_trainer_config.trained_model_file_path, 
